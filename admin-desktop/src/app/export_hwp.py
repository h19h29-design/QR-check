...
def export_hwp_or_fallback(
    ...
    try:
        ...
        return export_printable_html(records, target.with_suffix(".html"), school_name, items)

    html_path = export_printable_html(records, target.with_suffix(".html"), school_name, items)
